...
export default class WastafelScene extends Phaser.Scene {
  constructor() {
    super('WastafelScene');
  }

  preload(): void {
    this.load.image('scene_background_wastafel', '/images/wastafelWorkspace.webp');
  }
  ...
  create(): void {
    ...
    this.add.image(centerX, centerY, 'scene_background_wastafel');
