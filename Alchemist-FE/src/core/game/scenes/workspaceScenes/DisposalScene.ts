...
export default class DisposalScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    const binZone = this.add
      .zone(
        this.trashBin.x,
        this.trashBin.y,
        this.trashBin.displayWidth,
        this.trashBin.displayHeight
      )
    ...
    const hotbarContainer = this.add.rectangle(
      width / 2,
      hotbarY,
      5 * slotSize + 6 * padding,
      slotSize + 2 * padding,
      0x222222,
      0.9
    );
